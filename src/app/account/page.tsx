...
// Build a human-readable summary from a saved search filters object.
function summarizeFilters(filters: Record<string, unknown> | null): string {
  if (!filters) return "All listings";
  const parts: string[] = [];
  if (filters.listing_type)
    parts.push(String(filters.listing_type));
  if (filters.property_type && Array.isArray(filters.property_type))
...
// Serialize a saved search filters object back to a listings query string.
